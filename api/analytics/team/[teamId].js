/**
 * API Route: Get Team Analytics
 * 
 * This endpoint retrieves analytics data for a specific team.
 * 
 * Usage: GET /api/analytics/team/{teamId}?week=10&season=2024
 */
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const teamAnalytics = await analyticsService.getTeamAnalyticsScore(
      teamId,
