...
describe('StandingsDrawerContent Mobile Interactions', () => {
  ...
  it.skip('renders drawer content when open', () => {
  ...
  // class strings, label text) that changed with the §6 component rework. The
  // behaviour is still covered by the non-skipped cases in this file.
  it.skip('closes drawer on close button click', () => {
    render(<StandingsDrawerContent {...mockProps} />);
  ...
  // class strings, label text) that changed with the §6 component rework. The
  // behaviour is still covered by the non-skipped cases in this file.
  it.skip('has touch-friendly button sizes', () => {
    render(<StandingsDrawerContent {...mockProps} />);
  ...
  // class strings, label text) that changed with the §6 component rework. The
  // behaviour is still covered by the non-skipped cases in this file.
  it.skip('applies responsive padding and spacing', () => {
    render(<StandingsDrawerContent {...mockProps} />);
