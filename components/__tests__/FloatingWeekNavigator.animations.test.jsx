...
describe('FloatingWeekNavigator Animations', () => {
  ...
  describe('Week Button Animations', () => {
    ...
    it('should show loading animations during week selection', async () => {
      render(<FloatingWeekNavigator {...defaultProps} />);
    ...
    it('should apply shimmer animation to current week button', async () => {
  ...
  describe('Loading State Animations', () => {
    ...
    it('should apply pulse animation to loading elements', async () => {
      render(<FloatingWeekNavigator {...defaultProps} />);
